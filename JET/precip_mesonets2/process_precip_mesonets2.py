...
if __name__== '__main__':
   ...
   #sys.exit(1)
   models = ['RAP_OPS','RAP_GSD','HRRR_OPS','HRRR_GSD']
   for valid_time in valid_times:
    ...
    stations = []
    try:
       f = open("tmp/pcp_mesonet_stations."+str(int(valid_time))+".txt","r")
    except:
       print "tmp/pcp_mesonet_stations."+str(int(valid_time))+".txt not found!"
       continue
    ...
    for model in models:
        ...
        if True:
            ...
            if model.startswith("GFS"):
                fcst_lens = [3,4,5,6,7,8,9,12,15,18,24,30,36,48,72,96,120,168,240]
