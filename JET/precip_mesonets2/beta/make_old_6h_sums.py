...
#make 6h ob table
ob_table = "precip_mesonets2.6h_pcp2_{valid_time}".format(valid_time=valid_time)
...
create temporary  table {ob_table} (
  ...
  `bilin_pcp` int(10) unsigned DEFAULT NULL COMMENT 'estimated pcp in SIX hours in hundredths of an inch',
  UNIQUE KEY `time_id` (`valid_time`,`madis_id`),
  UNIQUE KEY `id_time` (`madis_id`,`valid_time`)
)  
select o1.madis_id,o1.valid_time
,o1.bilin_pcp+o2.bilin_pcp+o3.bilin_pcp+o4.bilin_pcp+o5.bilin_pcp+o6.bilin_pcp as bilin_pcp
from
hourly_pcp2 o1,hourly_pcp2 o2, hourly_pcp2 o3,hourly_pcp2 o4,hourly_pcp2 o5, hourly_pcp2 o6,
where 1=1
and o1.madis_id = o2.madis_id
and o1.madis_id = o3.madis_id
and o1.madis_id = o4.madis_id
and o1.madis_id = o5.madis_id
and o1.madis_id = o6.madis_id
and o2.valid_time = o1.valid_time - 1*3600
and o3.valid_time = o1.valid_time - 2*3600
and o4.valid_time = o1.valid_time - 3*3600
and o5.valid_time = o1.valid_time - 4*3600
and o6.valid_time = o1.valid_time - 5*3600
...
if rows == 0:
  ...
  for model in models:
      fcst_lens=[]
      if "HRRR" in model:
          fcst_lens = [6,12,18,24,30,36,42,48]
      print("fcst_lens: %s"%(fcst_lens))
      for fcst_len in fcst_lens:
        #print(fcst_len)
        make_6h_subregion_sums(cursor,model,valid_time,fcst_len,ob_table)
