...
def main():
    ...
    trshs   = ['00.0310','00.1500','00.2767','00.5224','00.7600','03.4700','06.9200','12.0000','31.6000']
    domains = ['ne','se','conus','east','west']
    sql_domains = ['NE','SE','CONUS','EUS','WUS']
    
    try:
        db = MySQLdb.connect(host="wolphin.fsl.noaa.gov", user="ejames", passwd="RckSpg", db="vil")
        cursor = db.cursor()
