...
#    elif (model.startswith(('rap','ruc'))):
    ...
    bools = [do_conus,do_west,do_east,do_ne,do_se,do_ci,do_hwt,do_roc,do_northwest]
    boolstrs = ['do_conus','do_west','do_east','do_ne','do_se','do_ci','do_hwt','do_roc','do_northwest']
    sfiles = [c_file,w_file,e_file,ne_file,se_file,ci_file,hwt_file,roc_file,northwest_file]
    sfileos = [c_fileo,w_fileo,e_fileo,ne_fileo,se_fileo,ci_fileo,hwt_fileo,roc_fileo,northwest_fileo]
