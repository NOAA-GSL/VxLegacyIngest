      subroutine iplst4_ruc10(field3,field4,nx,ny,nx10,ny10)
...
c
      parameter(ji=511*491,jo=169*153,km=1)  !new stage IV grid (4km)
...
c     ----      defines output grid   --------!RUC 40km
      data kgdso/3,169,153,29073,251528,8,265000,10159,10159,0,64,
