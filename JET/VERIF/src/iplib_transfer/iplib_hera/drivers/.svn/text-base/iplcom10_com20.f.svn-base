      subroutine iplcom10_com20(field3,field4,nx,ny,nx20,ny20)
      integer nx,ny,nx20,ny20
      real anx(nx,ny),fff(nx,ny),fff2(nx,ny),wmask(nx,ny)
      character*256 command
      character*9 aadate,adate
      real f(nx,ny,6) !various accumulations
      real field3(nx,ny),field4(nx20,ny20)
c
...
c
      parameter(ji=161*145,jo=81*73,km=1)  !new stage IV grid (4km)
...
c     data kgdsi/5,511,491,27973,250204,8,255000,4763,4763,0,64,
c    *0,0,0,0,0,0,0,0,255,0,0/
c
c
c     ----      defines input grid   --------!common 10km
      data kgdsi/3,161,145,29250,252000,8,263500,10000,10000,0,64,
     *35000,35000,0,0,0,0,0,0,255,0,0/ 
c
c
c     ----      defines output grid   --------!common 20km
      data kgdso/3,81,73,29250,252000,8,263500,20000,20000,0,64,
     *35000,35000,0,0,0,0,0,0,255,0,0/ 
c
