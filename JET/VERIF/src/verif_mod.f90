...
integer, dimension(200) :: hrrr03_gds, hrrr10_gds, hrrr20_gds, hrrr40_gds, hrrr80_gds, &
                           ...
                           hrrre03_ne_gds, hrrre03_n_gds, hrrre03_gds
...
! 3KM Lambert Conformal Conic - New HRRRE domain
parameter hrrre03_gds = (/ 3,1129,939,int(23.867*1000),int((360.-107.503)*1000),8,int((360.-97.5)*1000), &
                          3000,3000,0,64,int(38.5*1000),int(38.5*1000),0,0,0,0,0,0,255,(0,i=1,180)/) 
...
!-------------------------------------------------------------------------------------------------------------
  ...
  function get_gds(grid)
    ...
    if(trim(grid) == '03kmLC_E') get_gds = hrrre03_gds
