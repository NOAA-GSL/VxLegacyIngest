      subroutine iplst4_lap12(field3,field4,nx,ny,nx12,ny12)
...
c
      parameter(ji=511*491,jo=145*133,km=1)  !new stage IV grid (4km)
...
c
c
c     ----      defines output grid   --------!cut LAP 12km
      data kgdso/3,145,133,28995,251353,8,260200,12000,12000,0,64,
