      subroutine iplst4_ruc20(field3,field4,nx,ny,nx20,ny20)
...
c
      parameter(ji=511*491,jo=84*77,km=1)  !new stage IV grid (4km)
...
c
c
c     ----      defines output grid   --------!RUC 20km
      data kgdso/3,84,77,29172,251621,8,265000,20318,20318,0,64,
