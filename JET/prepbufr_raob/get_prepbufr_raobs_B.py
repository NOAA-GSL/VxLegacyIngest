...
mysql_filename = None
result =subprocess.check_output(['prepbufr2txt_d_DA.exe'])
...
# FOR THIS TEST, DON'T WRITE soundings_filename INTO THE DB (see line just below)
...
print("NOT query is {}".format(query))
