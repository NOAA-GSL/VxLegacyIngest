...
require "./load_summaries_retro.pl";
...
foreach my $basefile (@allfiles) {
	...
	print "model is $model\n";
        ...
        my $output = `./make_retro_tables.pl $model`;
        print $output; 
...
load_summaries_retro($dbh,$model,$fcst_len,$min_date,$max_date,0);
load_summaries_retro($dbh,$model,$fcst_len,$min_date,$max_date,-1);
load_summaries_retro($dbh,$model,$fcst_len,$min_date,$max_date,1);
load_summaries_retro($dbh,$model,$fcst_len,$min_date,$max_date,2);
