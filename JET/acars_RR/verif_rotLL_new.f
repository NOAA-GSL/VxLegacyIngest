...
**************************************************************************
c      parameter(rotcon = 0.70711) !sine of 45 degrees
      parameter(maxobs=200000)
      parameter(numproj=1)
      parameter(nreg=3)
c
c
c     hardwired coords for rotLL RR grid -- THIS MUST BE DONE IN TWO PLACES IN THIS FILE
c
      parameter(nlev=40)
      parameter(nx13=953,ny13=834)
      real lat_0_deg,lon_0_deg,dxy_km,lat_g_SW_deg,lon_g_SW_deg
      data lat_0_deg/54.0/
      data lon_0_deg/-106.0/
      data dxy_km/13.54508/
      data lat_g_SW_deg/-10.5906/
      data lon_g_SW_deg/-139.0858/
