...
**************************************************************************
      ...
      call getarg(7,arg)
      read(arg,*) alat1     ! lat_0_deg for grid_type 20 or 21
      call getarg(8,arg)
      read(arg,*) elon1    ! lon_o_deg for grid_type 20 or 21
      call getarg(9,arg)
      read(arg,*) elonv    ! lat_g_SW_deg for grid_type 20 or 21
      call getarg(10,arg)
      read(arg,*) alattan ! lon_g_SW_deg for grid_type 20 or 21
      call getarg(11,arg)
...
c     rotate wind fcst into wrt TRUE NORTH
c     
        if(uf(n,l).ne.-99999.9.and.vf(n,l).ne.-99999.9) then
           if(grid_type .eq. 20 .or. grid_type .eq. 21)  then
              lat_0_deg = alat1
              lon_0_deg = elon1
...
c  if needed for grid_type 20 or 21 (rotated latlon)
      ...
      acars_file = 'ACARS_BACKFILL_DIR' // '/' // adate // 'q.cdf'
