...
#SBATCH -D .
#SBATCH --mem=1G
#SBATCH -o tmp2/ACARS_db_load.o%j
#SBATCH -e tmp2/ACARS_db_load.e%j
#
...
load_summaries4($dbh,$model,$fcst_len,$min_date,$max_date,0);
load_summaries4($dbh,$model,$fcst_len,$min_date,$max_date,-1);
load_summaries4($dbh,$model,$fcst_len,$min_date,$max_date,1);
load_summaries4($dbh,$model,$fcst_len,$min_date,$max_date,2);
