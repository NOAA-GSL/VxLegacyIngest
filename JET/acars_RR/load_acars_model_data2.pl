...
(date,xid,lat,lon,press,t,dir,s,hdg,ul,vx,mach,rh,ht,ap_id,up_dn)
select from_unixtime(t.time),xid,lat,lon,press,t,dir,s,hdg,ul,vx,mach,rh,ht,ap_id,up_dn
