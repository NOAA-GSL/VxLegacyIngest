...
c     Moninger, Jun-July 2014 - adapted for variable lambort cc grids
...
**************************************************************************
      ...
      integer grib_type
      integer grid_type
      real alat1,elon1,elonv,alattan
      integer dx,nx,ny,nz
      character*80 arg
...
c****************************************************************************
       print *,'args are',adate,model,grib_file,grib_type,grid_type,
     . output_file,alat1,elon1,elonv,alattan,dx,nx,ny,nz
...
c     
c        write(6,3255) rotcon
 3255   format('rotcon is ',f)
...
c
      ...
      PARAMETER (NREC= 40000)   !CHANGE THIS TO GENERALIZE
...
c
      parameter (alat1=1.066,elon1=231.5)
      parameter(dx=13545.00) !grid mesh
      parameter(elonv=265.00) !this is -95W + 360
      parameter(alatan=45.00) !true
      parameter(dx13=13545.0,dy13=13545.0)
      parameter(rotcon = 0.7071) !sine of alatan
      parameter(nz=40)
      parameter(nx=648,ny=647)
c
      integer plev(nz)
...
c
 ...
 500     continue
         ...
         write(25,550) ihr,imin,isec,
     *        tailnum(i),latitude(i),longitude(i),altitude(i),
     *        temperature(i),winddir(i),windspeed(i),
     *        heading(i),mach(i),errortype(i),
     *        correctedflag(i),rollflag(i),temperror(i),winddirerror(i),
     *        windspeederror(i),speederror(i),bounceerror(i)
...
c
     ...
     *        elonv,alatan,rix,rjy)
c            write(42,4850) latitude(i),longitude(i),rix,rjy
