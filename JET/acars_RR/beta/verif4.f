...
**************************************************************************
      ...
      call verif4a (adate,model,grib_file,grib_type,grid_type,
     . output_file,alat1,elon1,elonv,alattan,dx,nx,ny,nz)
      end

      subroutine verif4a (adate,model,grib_file,grib_type,grid_type,
     . output_file,alat1,elon1,elonv,alattan,dx,nx,ny,nz)
...
c
      ...
      PARAMETER (NREC= 20000)   !CHANGE THIS TO GENERALIZE
