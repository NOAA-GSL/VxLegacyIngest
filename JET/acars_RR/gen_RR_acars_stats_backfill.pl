...
my @fcst_lens = (0,1,3,6,9,12,18,24,30,36,42,48);
...
require "get_RR_prs_file_backfill.pl";
require "get_grid.pl";
my($grib_file,$grid_type,$desired_fcst_len) =
    get_RR_prs_file_backfill($run_time,$model,$DEBUG,$fcst_len,0);
...
my $arg;
	...
	$dx = 13.54508;
	$grib_nz = 37;
 	$arg = "./verif5_backfill.x $atime $model $grib_file $grib_type $grid_type $f_out_file ".
