...
#	$anal_dir = "/whome/rtrr/rr/WRFDATE/postprd/";
	$anal_dir = "/lfs1/BMC/amb-verif/backfill/RAP/WRFDATE/postprd/";
    } elsif($data_source eq "RAP_OPS_WCOSS") {
	$anal_dir = "/lfs4/BMC/rtwbl/mhu/wcoss/nco/cycles/ncorap/WRFDATE/postprd/";
    } elsif($data_source eq "HRRR_OPS_WCOSS2_a") {
	$anal_dir = "/lfs4/BMC/rtwbl/mhu/wcoss/nco/cycles/ncohrrr/WRFDATE/postprd/";
    } elsif($data_source eq "HRRR_AK_OPS_WCOSS2") {
	$anal_dir = "/lfs4/BMC/rtwbl/mhu/wcoss/nco/cycles/ncohrrrak/WRFDATE/postprd/";
	...
	$anal_dir = "/lfs4/BMC/amb-verif/backfill/HRRR/WRFDATE/postprd/";
    } elsif($data_source eq "HRRR_AQPI_1km_SFO") {
	$anal_dir = "/lfs4/BMC/wrfruc/ejames/datasets/aqpi_nest/1km/WRFDATE/postprd/";
	...
	$anal_dir = "/lfs1/BMC/amb-verif/hrrr_smoke/WRFDATE/postprd/";
	...
	$anal_dir = "/whome/rtrr/hrrr_nest2_dev/WRFDATE/postprd/";
        ...
        $anal_dir = "/lfs1/BMC/amb-verif/backfill/HRRR_AK/WRFDATE/postprd/";
        ...
        $anal_dir = "/lfs1/BMC/amb-verif/backfill/HRRR_dev3/WRFDATE/postprd/";
...
#	$anal_dir = "/public/gsd/hrrr_ncep/conus/wrfprs/";
	...
	$anal_dir = "/lfs4/BMC/amb-verif/backfill/HRRR_OPS/wrfprs/";
    } elsif($data_source eq "HRRR_AK_OPS") {
	$anal_dir = "/lfs1/BMC/amb-verif/backfill/HRRR_AK_OPS/wrfprs";
	...
	$anal_dir = "/lfs4/BMC/rtwbl/mhu/wcoss/emc/ncorap/WRFDATE/postprd/";
...
#	$suffix = "";
	...
	$anal_dir = "/lfs1/BMC/amb-verif/backfill/RAP_OPS/wrfprs";
	$suffix = "";
    ...
    if($anal_dir =~ /grib2/ ||
       ...
       $anal_dir =~ m|amb-verif/hrrr_ops| ||
       $anal_dir =~ m|amb-verif/backfill| ||
	...
	if($data_source =~ /^RAP/) {
		...
		if($data_source eq "RRnc") {
            ...
            if($data_source eq "RAP_NCO_noIVEA" || $data_source eq "RAP_OPS_WCOSS") {
		...
		if($data_source eq "RRnc") {
		    ...
		    $base_file = sprintf("wrfprs_rr_%02d.grib2",$desired_fcst_len);
                ...
                $base_file = sprintf("wrfnat_hrnest1_%02d.grib2",$desired_fcst_len);
        } elsif($data_source eq "HRRR_WFIP2") {
       ...
       #         $base_file = sprintf("wrftwo_hrconus_%02d.grib2",$desired_fcst_len);
		...
		$base_file = sprintf("wrfnat_hrconus_%02d.grib2",$desired_fcst_len);
	} elsif($data_source eq "RUA_dev1") {
		$base_file = sprintf("wrftwo_hrconus_%02d.grib2",$desired_fcst_len);
	} elsif($data_source eq "RUA_AK") {
		$base_file = sprintf("wrftwo_hrconus_%02d.grib2",$desired_fcst_len);
