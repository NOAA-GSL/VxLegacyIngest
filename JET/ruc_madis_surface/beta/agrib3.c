...
/**int agrib_ceil3_(int *nz_ptr, int *n_g3_fields,int *g3_fields,
...
* C:
  ...
  result = agrib_ceil3_(&nz,&n_g3_fields,g3_fields,
...
* FORTRAN
      ...
      inteter ret,istatus
      ...
      ret = agrib_ceil3(nlev,n_g3_fields,g3_fields,
...
/*END MYCODE*/
    ...
    printf("in agrib_ceil3: filename = %s\n", filename);
...
if (output_type == BINARY) {
  ...
  if(PDS_KPDS6(pds) == 109) {
    ...
    for(i=0;i<*n_g2_fields;i++) {
	 ...
	 /* hardwire cloud base in this verion */
	 PDS_KPDS6(pds) == i+1) { /* 1 = 'sfc', 2 = 'cld base' */
	/* this field matches */
	printf("filling surface field |%s| (%d) %s ",
	  k5toa(pds),PDS_PARAM(pds),k5_comments(pds));
	/* print level */
