...
#SBATCH --mem=16G
#SBATCH -D .
#SBATCH -e /home/amb-verif/ruc_madis_surface/tmp/sfc_backfill_verif.e%j
#SBATCH -o /home/amb-verif/ruc_madis_surface/tmp/sfc_backfill_verif.o%j
#
use strict;
use English;
my $DEBUG=1;
...
require "./get_iso_file3_backfill.pl";
require "./jy2mdy.pl";
...
require "./get_grid.pl";
require "./get_obs_retro_at_hr_q.pl";
