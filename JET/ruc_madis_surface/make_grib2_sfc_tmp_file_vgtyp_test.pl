...
#print "/apps/wgrib2/2.0.8/intel/18.0.5.274/bin/wgrib2 -i -order raw -no_header -bin $thisDir/$out_file $file >/dev/null 2>&1";
print "/apps/wgrib2/0.1.9.6a/bin/wgrib2 -i -order raw -no_header -bin $thisDir/$out_file $file >/dev/null 2>&1";

open(D,"|/apps/wgrib2/0.1.9.6a/bin/wgrib2 -i -order raw -no_header -bin $thisDir/$out_file $file >/dev/null 2>&1") ||
