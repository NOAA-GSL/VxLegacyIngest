...
#	$anal_dir = "/whome/rtrr/rr/WRFDATE/postprd/";
	...
	#$anal_dir = "/public/data/grids/gfs/0p5deg/grib2/";
    } elsif($data_source eq "GFSv17p8_gf") {
	$anal_dir = "/home/rtfim/GFSv17p8_HFIP/FV3GFSrun/rt_v17_p8_gf/gfs.RRFSDATE/atmos";
    } elsif($data_source eq "GFSv17p8_mynn") {
	$anal_dir = "/home/rtfim/GFSv17p8_HFIP/FV3GFSrun/rt_v17_p8_mynn/gfs.RRFSDATE/atmos";
    } elsif($data_source eq "rt_gfsv16_mynn") {
	$anal_dir = "/lfs4/BMC/gsd-fv3-dev/rtruns/GFSv16_HFIP/FV3GFSrun/rt_gfsv16_mynn/gfs.RRFSDATE/atmos";
    } elsif($data_source eq "rt_gfsv16_thmp_subcyc") {
	$anal_dir = "/lfs4/BMC/gsd-fv3-dev/rtruns/GFSv16_HFIP/FV3GFSrun/rt_gfsv16_thmp_subcyc/gfs.RRFSDATE/atmos";
    } elsif($data_source eq "rt_ccpp_gsd_L128") {
	$anal_dir = "/lfs4/BMC/gsd-fv3-dev/rtruns/UFS-CAMsuite_jet/FV3GFSrun/rt_ufscam_l127/gfs.RRFSDATE/atmos";
	...
	$anal_dir = "/whome/rtrr/hrrrv4_ncepfcst/WRFDATE/postprd/";
    } elsif($data_source eq "HRRR_AKv4_NCEP") {
	$anal_dir = "/lfs1/BMC/nrtrr/HRRRv4_AK_NCEPfcst/run/WRFDATE/postprd/";
    ...
    } elsif($data_source eq "RRFSE_mem1") {
        $anal_dir = "/lfs4/BMC/wrfruc/RRFSE/NCO_dirs/ptmp/com/RRFS_CONUS/para/RRFS_conus_3km.RRFSDATE/mem0001";
    } elsif($data_source eq "RRFSE_mem2") {
        $anal_dir = "/lfs4/BMC/wrfruc/RRFSE/NCO_dirs/ptmp/com/RRFS_CONUS/para/RRFS_conus_3km.RRFSDATE/mem0002";
    } elsif($data_source eq "RRFSE_mem3") {
        $anal_dir = "/lfs4/BMC/wrfruc/RRFSE/NCO_dirs/ptmp/com/RRFS_CONUS/para/RRFS_conus_3km.RRFSDATE/mem0003";
    } elsif($data_source eq "RRFSE_mem4") {
        $anal_dir = "/lfs4/BMC/wrfruc/RRFSE/NCO_dirs/ptmp/com/RRFS_CONUS/para/RRFS_conus_3km.RRFSDATE/mem0004";
    } elsif($data_source eq "RRFSE_mem5") {
        $anal_dir = "/lfs4/BMC/wrfruc/RRFSE/NCO_dirs/ptmp/com/RRFS_CONUS/para/RRFS_conus_3km.RRFSDATE/mem0005";
    } elsif($data_source eq "RRFSE_mem6") {
        $anal_dir = "/lfs4/BMC/wrfruc/RRFSE/NCO_dirs/ptmp/com/RRFS_CONUS/para/RRFS_conus_3km.RRFSDATE/mem0006";
    } elsif($data_source eq "RRFSE_mem7") {
        $anal_dir = "/lfs4/BMC/wrfruc/RRFSE/NCO_dirs/ptmp/com/RRFS_CONUS/para/RRFS_conus_3km.RRFSDATE/mem0007";
    } elsif($data_source eq "RRFSE_mem8") {
        $anal_dir = "/lfs4/BMC/wrfruc/RRFSE/NCO_dirs/ptmp/com/RRFS_CONUS/para/RRFS_conus_3km.RRFSDATE/mem0008";
    } elsif($data_source eq "RRFSE_mem9") {
        $anal_dir = "/lfs4/BMC/wrfruc/RRFSE/NCO_dirs/ptmp/com/RRFS_CONUS/para/RRFS_conus_3km.RRFSDATE/mem0009";
...
#	$anal_dir = "/public/gsd/hrrr_ncep/conus/wrfprs/";
    ...
    } elsif($data_source eq "HRRR_GSL_ret_archive") {
        $anal_dir = "/lfs1/BMC/amb-verif/backfill/HRRR_GSL_ret_archive/WRFDATE/postprd/";
...
#	$suffix = "";
	...
	if($data_source =~ /^RAP/) {
		...
		if($data_source eq "RRnc") {
            ...
            if($data_source eq "RAPv5_NCO" || $data_source eq "RAPv5_EMC" || $data_source eq "RAP_NCO_gfsv16_test" ) {
                $base_file = sprintf("rap.t%02dz.wrfprsf%02d.grib2",$hour,$desired_fcst_len);
            }
            if($data_source eq "RAPv5_NCO_130" || $data_source eq "RAPv5_EMC_130" || $data_source eq "RAP_NCO_gfsv16_test_130" ) {
                $base_file = sprintf("rap.t%02dz.awp130pgrbf%02d.grib2",$hour,$desired_fcst_len);
            }
        } elsif($data_source =~  /^RRFS_dev/) { # Handle RRFS_dev2-4
                $base_file = sprintf("RRFS_CONUS.t%02dz.bgdawp%02d.tm00",$hour,$desired_fcst_len);
	...
	$filename = "${anal_dir}$base_file";
        ...
        my $rrfs_date= sprintf("%04d%02d%02d/%02d",
                               $year+1900,$mon+1,$mday,$hour);
        if ($data_source =~ /^RRFS_dev/) { 
            # Currently this handles RRFS_dev1 as a special case        
        ...
        } elsif ($data_source =~ /^GFSv17/) {
            $anal_dir =~ s/RRFSDATE/$rrfs_date/;
            $base_file = sprintf("gfs.t%02dz.pgrb2.0p25.f%03d",$hour,$desired_fcst_len);
        } elsif ($data_source =~ /^rt_gfs/) {
            $anal_dir =~ s/RRFSDATE/$rrfs_date/;
            $base_file = sprintf("gfs.t%02dz.pgrb2.0p25.f%03d",$hour,$desired_fcst_len);
        } elsif($data_source =~  /^RRFSE/) { # Handle RRFSE members
            $anal_dir =~ s/RRFSDATE/$rrfs_date/;
            $base_file = sprintf("RRFS_CONUS.t%02dz.bgsfcf%03d.tm00.grib2",$hour,$desired_fcst_len);
...
#                exit;
	...
	if($data_source eq "RTMA_OPS_smartinit_hrrr") {
                ...
                $base_file = sprintf("%04d%03d%02d00.rtma2p5.t%02dz.hrrr.t%02dz.smarthrrrconusf%02d.grib2.%04d%02d%02d",$year+1900,$yday+1,$next_hour,$next_hour,$hour,$desired_fcst_len,$year+1900,$mon+1,$mday);
                $filename = "${anal_dir}$base_file";
	} 
        if($data_source eq "RTMA_OPS_smartinit_rap") {
                ...
                $base_file = sprintf("%04d%03d%02d00.rtma2p5.t%02dz.rap.t%02dz.smartrapconusf%02d.grib2.%04d%02d%02d",$year+1900,$yday+1,$next_hour,$next_hour,$hour,$desired_fcst_len,$year+1900,$mon+1,$mday);
                $filename = "${anal_dir}$base_file";
        }
