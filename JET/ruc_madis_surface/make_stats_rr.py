...
from surface_sums2.RAP_NCEP_full_metar_v2_ALL_HRRR
where 1=1
...
# New entry to only grab ASOS/AWOS stations normally inside the METARS net. - Hamilton 20190308

query = """insert into """+table+""" 
select 'ASOS',sta_id,time,temp,dp,wd,ws
from """+model_base+"""_short as m,stations as s, metar_networks as n
where 1=1
and s.id = m.sta_id
...
query = """insert into """+table+""" 
select 'AWOS',sta_id,time,temp,dp,wd,ws
from """+model_base+"""_short as m,stations as s, metar_networks as n
where 1=1
and s.id = m.sta_id
and m.sta_id = n.madis_id
