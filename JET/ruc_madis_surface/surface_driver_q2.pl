...
#SBATCH --mem=16G
#SBATCH -D .
#SBATCH -o /home/%u/ruc_madis_surface/tmp/XXsfc_verif.o%j
#
use strict;
use English;
my $DEBUG=1;
...
if($data_source eq "NAMnest_OPS_227") {
    ...
    @regions = qw[NHX_E NHX_W NHX Global SHX TRO ALL_RR1 ALL_RUC E_RUC W_RUC
                             ALL_HRRR E_HRRR W_HRRR AK HWT STMAS_CI];
    @fcst_lens = (0,6,12,18,24,36,48,60,72,84,96,108,120);
    $WRF=1;
    ...
    @fcst_lens = (0,1,2,3,6,9,12,15,18,21,24,27,30,33,36);
    $WRF=1;
} elsif($data_source =~ /^RRFS_NA_3km_dev1_HRRR/) {
    @regions = qw[ALL_HRRR E_HRRR W_HRRR HWT STMAS_CI HI NORTHWEST];
    @fcst_lens = (0,1,2,3,6,9,12,15,18,21,24,27,30,33,36);
    $WRF=1; 
} elsif($data_source =~ /^RRFS_NA_3km_dev1_AK/) {
    @regions = qw[AK];
    @fcst_lens = (0,1,2,3,6,9,12,15,18,21,24,27,30,33,36);
    $WRF=1;
    ...
    # leave out 1h forecasts below; those are
    # generated by surface_driver_all_nets.pl
    @fcst_lens = (0,2,3,6,9,12,15,18,21,24,30,36,42,48);
    $WRF=1;
    ...
    # leave out 1h forecasts below; those are
    # generated by surface_driver_all_nets.pl
    @fcst_lens = (0,2,3,6,9,12,18,24,30,36,42,48,51);
    $WRF=1;
