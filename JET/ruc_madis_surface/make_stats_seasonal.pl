...
#SBATCH --mem=1G
#SBATCH -D .
#SBATCH -o /home/amb-verif/ruc_madis_surface/tmp/madis_seasonal_stats.o%j
#SBATCH -e /home/amb-verif/ruc_madis_surface/tmp/madis_seasonal_stats.e%j
#
use strict;
...
my $n_rows;
my $table;
print "Calculating surface stats for $season season, begining $startSecs epoch, ending $endSecs epoch\n\n";
...
from HRRRqp1f as m, stations as s, metar_networks as n    #, (emacs coloration)
where 1=1
and m.sta_id = s.id
