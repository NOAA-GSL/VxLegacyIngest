...
my $base_file = "${max_day_found}_HRRR_meso_uselist.txt";
my $uselist_dir = "hrrr_mesonet_uselists";
...
print OUT qq{; First, we go through  table \'$stats_table\' and\n}.
    ...
    qq{; wind, temperature, and dewpoint separately (as specified in table madis3.$limits_table)\n};
