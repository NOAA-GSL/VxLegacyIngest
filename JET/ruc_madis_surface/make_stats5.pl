...
select net,count(distinct m.sta_id) as N_sites
 ...
 ,count(o.ws) as N_S
 ,avg(o.ws) as avg_S, avg(o.ws-m.ws) as bias_S
 ,std(o.ws-m.ws) as std_S
 ,sum(if(o.ws  > 5 &&
        m.ws > 5,1,0)) as N_DIR
 ,avg(if(o.ws  > 5 &&
        m.ws > 5,
        if(o.wd-m.wd  between -180 and 180,
           o.wd-m.wd ,
           if(o.wd-m.wd  > 180,
              o.wd-m.wd -360,
              o.wd-m.wd +360)),null)) as bias_DIR
 ,std(if(o.ws  > 5 &&
        m.ws > 5,
        if(o.wd-m.wd  between -180 and 180,
           o.wd-m.wd ,
