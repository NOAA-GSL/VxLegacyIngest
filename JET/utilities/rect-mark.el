Here is version 1.4 of rect-mark.el.  Newsworthy items:

* works correctly with recent versions of GNU Emacs (e.g. 19.28)
* integrates rectangles with the kill ring and non-rectangular contexts
* offers keyboard and mouse selection for inter-program cut and paste
* is much more efficient for very large rectangles
* has somewhat simpler ~/.emacs usage
...
command like \\[kill-rectangle], by inserting text, or by typing
\\[keyboard-quit].
