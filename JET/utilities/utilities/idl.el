...
;;     Phil Williams <phil@peace.med.ohio-state.edu>
...
(defconst idl-mode-version "1.28")
...
(if idl-mode-abbrev-table
  ...
  (let ((abbrevs-changed nil))
    ...
    ;; Templates
    ;; 
    (define-abbrev idl-mode-abbrev-table  ".c"   "" (idl-code-abbrev idl-case))
    (define-abbrev idl-mode-abbrev-table  ".f"   "" (idl-code-abbrev idl-for))
    (define-abbrev idl-mode-abbrev-table  ".fu"  "" (idl-code-abbrev idl-function))
    (define-abbrev idl-mode-abbrev-table  ".pr"  "" (idl-code-abbrev idl-procedure))
    (define-abbrev idl-mode-abbrev-table  ".r"   "" (idl-code-abbrev idl-repeat))
    (define-abbrev idl-mode-abbrev-table  ".w"   "" (idl-code-abbrev idl-while))
    (define-abbrev idl-mode-abbrev-table  ".i"   "" (idl-code-abbrev idl-if))
    (define-abbrev idl-mode-abbrev-table  ".elif"   "" (idl-code-abbrev idl-elif))
    ;;
