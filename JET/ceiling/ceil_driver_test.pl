...
#SBATCH --mem=1G
#SBATCH -D .
#SBATCH -e /home/amb-verif/ceiling/tmp/ceil_dr_test.e%j
#SBATCH -o /home/amb-verif/ceiling/tmp/ceil_dr_test.o%j
#
#
use strict;
...
my $arg_unsafe = "$thisDir/ceil_test.x ".
