...
sub get_iso_file3 {
	...
	$anal_dir = "/lfs1/BMC/amb-verif/backfill/HRRR_AK/WRFDATE/postprd/";
        ...
        $anal_dir =
            sprintf("/lfs1/BMC/amb-verif/backfill/HRRR_AK_OPS/wrfprs/");
    } elsif($data_source eq "HRRR") {
	$anal_dir = "/lfs1/BMC/amb-verif/backfill/HRRR/WRFDATE/postprd/";
	...
	$anal_dir = "/pan2/projects/public/data/gsd/hrrr_nrel/conus/wrfnat/";
        ...
        $anal_dir =
            sprintf("/lfs4/BMC/amb-verif/backfill/hrrr_ops/");
	$suffix = "";
...
#	if($data_source =~ /prs/) {
	if($data_source =~ /prs/ && $data_source !~ /^RR/) {
        ...
        } elsif($data_source eq "RAP_NCO_noIVEA" || $data_source eq "RAP_OPS_WCOSS") {
