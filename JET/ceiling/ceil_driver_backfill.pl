...
#SBATCH --mem=1G
#SBATCH -D .
#SBATCH -e /home/amb-verif/ceiling/tmp/ceil_dr_backfill.e%j
#SBATCH -o /home/amb-verif/ceiling/tmp/ceil_dr_backfill.o%j
#
#
use strict;
...
require "./jy2mdy.pl";
require "./update_summaries_backfill.pl";
require "./get_grid.pl";
require "./set_connection.pl";

my $usage = "usage: $0 model [start secs] [end secs] [1 to reprocess, 0 otherwise]\n";
if(@ARGV < 3) {
    print $usage;
}
if (@ARGV < 1) {
