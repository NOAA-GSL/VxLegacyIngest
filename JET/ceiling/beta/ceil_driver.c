...
main (int argc, char *argv[])
{
  ...
  if(argc < 13) {
    printf("Usage: ceil_driver.x model valid_time filename grib_type tmp_file data_file fcst_len"
  ...
  if(n_stations > 0) {
    n_zero_ceils = fill_ceil_values(model,STATIONS,n_stations,filename,grib_type,grid_type,tmp_file,
