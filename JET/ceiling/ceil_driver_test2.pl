...
#SBATCH --mem=1G
#SBATCH -D .
#SBATCH -e /home/amb-verif/ceiling/tmp/ceil_dr_test2.e%j
#SBATCH -o /home/amb-verif/ceiling/tmp/ceil_dr_test2.o%j
#
#
use strict;
...
my $arg_unsafe = "$thisDir/ceil_test2.x ".
...
if($grid_type == 20 || $grid_type==21 ) {
    ...
    $arg_unsafe = "$thisDir/rotLL_ceil_test2.x $data_source $valid_time ".
