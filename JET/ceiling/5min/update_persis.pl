...
#SBATCH --mem=1G
#SBATCH -D .
#SBATCH -e /home/amb-verif/ceiling/5min/tmp/ceil_5min_persis.e%j
#SBATCH -o /home/amb-verif/ceiling/5min/tmp/ceil_5min_persis.o%j
#
#
use strict;
...
foreach my $fcst_len_min (@fcst_len_mins) {
    ...
    my @regions = qw(E_US GtLk ALL_HRRR E_HRRR W_HRRR);
foreach my $region (@regions)  {
    my $table = "${model}_$region";
    my $table_list = "metars_5min.metars,ceiling_5min.obs as ob,ceiling_5min.obs as o1";
