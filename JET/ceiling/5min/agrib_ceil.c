...
/**int agrib_ceil_(int *nz_ptr, int *n_g3_fields,int *g3_fields,
...
* C:
  ...
  result = agrib_ceil_(&nz,&n_g3_fields,g3_fields,
...
* FORTRAN
      ...
      inteter ret,istatus
      ...
      ret = agrib_ceil(nlev,n_g3_fields,g3_fields,
...
/*END MYCODE*/
    ...
    printf("in agrib_ceil: filename = %s\n", filename);
...
if (output_type == BINARY) {
  ...
  if(PDS_KPDS6(pds) == 109) {
    ...
    for(i=0;i<*n_g2_fields;i++) {
	 ...
	 (PDS_KPDS6(pds) == 2 || /* 'cld base', for 'DIST' */
	  PDS_KPDS6(pds) == 1)) { /* 'sfc', for 'HGT' */
	/* this field matches */
