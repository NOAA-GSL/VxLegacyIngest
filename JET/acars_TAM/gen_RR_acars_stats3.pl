...
#SBATCH -D .
#SBATCH --mem=16G
#SBATCH -o tmp/TAMDAR_verif.o%j
#SBATCH -e tmp/TAMDAR_verif.e%j
#
...
my @valid_times = ($first_time,$first_time - 1*3600,$first_time - 2*3600,$first_time - 3*3600);
...
sub already_processed {
    ...
    # because files in tmp2/ are scrubbed (see just above) after 1 day
