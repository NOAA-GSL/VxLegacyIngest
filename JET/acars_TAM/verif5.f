...
c i+1 and j+1
         if(rix.lt.1.or.rix.gt.nx-1) rix = 99.9
         if(rjy.lt.1.or.rjy.gt.ny-1) rjy = 99.9
c     
c     
         if(rix.eq.99.9.or.rjy.eq.99.9) go to 700
c         if(i .lt. 100) then
c            write(6,4850) i,latitude(i),longitude(i),rix,rjy
...
c
        ...
        if (i < 1 .or. i > nx-1 .or. j < 1 .or. j > ny-1)  then
          result = -99999.9
          write(6,1001) i,j
 1001     format('.OUT OF BOUNDS: ',i3,1x,i3)
          go to 111
        endif
