...
system("/usr/bin/java Verify Op20 9 $start_secs $end_secs") &&
    die "problem with command: $!";
system("/usr/bin/java Verify Op20 12 $start_secs $end_secs") &&
    die "problem with command: $!";
system("/usr/bin/java Verify GFS 0 $start_secs $end_secs") &&
    die "problem with command: $!";
system("/usr/bin/java Verify GFS 6 $start_secs $end_secs") &&
    die "problem with command: $!";
system("/usr/bin/java Verify GFS 12 $start_secs $end_secs") &&
    die "problem with command: $!";
system("/usr/bin/java Verify NAM 0 $start_secs $end_secs") &&
    die "problem with command: $!";
system("/usr/bin/java Verify NAM 6 $start_secs $end_secs") &&
    die "problem with command: $!";
system("/usr/bin/java Verify NAM 12 $start_secs $end_secs") &&
    die "problem with command: $!";
}
system("/usr/bin/java Verify FIM  0 $start_secs $end_secs") &&
    die "problem with command: $!";
system("/usr/bin/java Verify FIM 12 $start_secs $end_secs") &&
    die "problem with command: $!";
system("/usr/bin/java Verify FIM 24 $start_secs $end_secs") &&
    die "problem with command: $!";
system("/usr/bin/java Verify FIM 36 $start_secs $end_secs") &&
    die "problem with command: $!";
