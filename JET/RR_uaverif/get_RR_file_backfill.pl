...
sub get_model_file2 {
	...
	$anal_dir = "/lfs1/BMC/amb-verif/backfill/RAP_OPS/wrfnat";
 	$template = sprintf("%02d%03d%02d%06d",
			    $year%100,$yday+1,$hour,$desired_fcst_len);
	...
	$anal_dir = "/lfs3/BMC/amb-verif/scratch/rap_iso";
 	$template = sprintf("%02d%03d%02d%06d",
			    $year%100,$yday+1,$hour,$desired_fcst_len);
    } elsif($data_source eq "RAP_OPS_WCOSS_iso") {
	$anal_dir = sprintf("/lfs4/BMC/rtwbl/mhu/wcoss/nco/cycles/ncorap/%4d%2.2d%2.2d%2.2d/postprd",
                    $year+1900,$month+1,$mday,$hour);
 	$template = sprintf("rap.t%02dz.wrfprsf%02d.grib2",
			    $hour,$desired_fcst_len);
    } elsif($data_source eq "HRRR_OPS_WCOSS2_a_iso") {
        $anal_dir = sprintf("/lfs4/BMC/rtwbl/mhu/wcoss/nco/cycles/ncohrrr/%4d%2.2d%2.2d%2.2d/postprd",
                    $year+1900,$month+1,$mday,$hour);
        $template = sprintf("hrrr.t%02dz.wrfprsf%02d.grib2",
                            $hour,$desired_fcst_len);
    } elsif($data_source eq "HRRR_AK_OPS_WCOSS2_iso") {
        $anal_dir = sprintf("/lfs4/BMC/rtwbl/mhu/wcoss/nco/cycles/ncohrrrak/%4d%2.2d%2.2d%2.2d/postprd",
                    $year+1900,$month+1,$mday,$hour);
        $template = sprintf("hrrr.t%02dz.wrfprsf%02d.ak.grib2",
                            $hour,$desired_fcst_len);
...
#    } elsif($data_source eq "RAPv3_EMC") {
	...
	$anal_dir =
       ...
       $anal_dir =
            sprintf("/lfs1/BMC/amb-verif/backfill/RAP/%4d%2.2d%2.2d%2.2d/postprd",
                    $year+1900,$month+1,$mday,$hour);
	...
	$anal_dir =
	    sprintf("/lfs1/BMC/amb-verif/backfill/HRRR/%4d%2.2d%2.2d%2.2d/postprd",
		    $year+1900,$month+1,$mday,$hour);
	...
	$anal_dir =
	    sprintf("/lfs1/BMC/amb-verif/backfill/HRRR_AK/%4d%2.2d%2.2d%2.2d/postprd",
		    $year+1900,$month+1,$mday,$hour);
...
#	    sprintf("/public/gsd/hrrr_ncep/conus/wrfnat/");
	...
	$anal_dir =
	    sprintf("/lfs1/BMC/amb-verif/backfill/HRRR_OPS/wrfnat");
    } elsif($data_source eq "HRRR_OPS_iso") {
	$anal_dir =
	    sprintf("/lfs4/BMC/wrfruc/ejames/datasets/aqpi_nest/hrrr/");
	...
	$anal_dir =
        ...
        $anal_dir =
            sprintf("/lfs1/BMC/amb-verif/hrrr_ak_ops");
    } elsif($data_source eq "HRRR_AK_OPS") {
        $anal_dir =
            sprintf("/lfs1/BMC/amb-verif/hrrr_ak_ops/wrfnat/");
	...
	$anal_dir = "/pan2/projects/public/data/grids/rap/iso_130/grib2";
        ...
        $anal_dir =
            sprintf("/lfs4/BMC/amb-verif/backfill/rt_ccpp_gsd_L128/%4d%2.2d%2.2d%2.2d/",
                $year+1900,$month+1,$mday,$hour);
