...
#        $template = sprintf("RRFS_CONUS.t%02dz.bgdawp%02d.tm%02d",$hour,$desired_fcst_len,$hour);
        ...
        $anal_dir =
            sprintf("/home/rtrr/rtma_b/para/RTMA_CONUS.%04d%02d%02d/%02d",
                    $year+1900,$month+1,$mday,$hour);
        $template = sprintf("RTMA_CONUS.t%02dz.bgrd3df%03d.tm00.grib2",$hour,$desired_fcst_len);
    } elsif($data_source eq "RTMA_B_iso") {
        $anal_dir =
            sprintf("/home/rtrr/rtma_b/para/RTMA_CONUS.%04d%02d%02d/%02d",
                    $year+1900,$month+1,$mday,$hour);
        $template = sprintf("RTMA_CONUS.t%02dz.bgdawpf%03d.tm00.grib2",$hour,$desired_fcst_len);
	...
	$anal_dir =
    ...
    } elsif($data_source eq "RRFS_NA_3km_test") {
        $anal_dir =
            sprintf("/lfs4/BMC/amb-verif/hamilton/rrfs_na_3km_test/%04d%02d%02d%02d/postprd",
                    $year+1900,$month+1,$mday,$hour);
        ...
        $anal_dir =
            sprintf("/lfs4/BMC/rtwbl/mhu/wcoss/emc/rrfsna/rrfs_a.%04d%02d%02d/%02d",
                    $year+1900,$month+1,$mday,$hour);
        $template = sprintf("rrfs_a.t%02dz.bgrd3df%03d.tm00.grib2",$hour,$desired_fcst_len);
    } elsif($data_source eq "RRFS_NA_3km_dev1_iso") {
        $anal_dir =
            sprintf("/lfs4/BMC/rtwbl/mhu/wcoss/emc/rrfsna/rrfs_a.%04d%02d%02d/%02d",
                    $year+1900,$month+1,$mday,$hour);
        $template = sprintf("rrfs_a.t%02dz.bgdawpf%03d.tm00.grib2",$hour,$desired_fcst_len);
    } elsif($data_source eq "RRFS_NA_3km_dev1_HRRR_iso") {
        $anal_dir =
            sprintf("/lfs4/BMC/rtwbl/mhu/wcoss/emc/rrfsna/rrfs_a.%04d%02d%02d/%02d",
                    $year+1900,$month+1,$mday,$hour);
        $template = sprintf("rrfs.t%02dz.prslev.f%03d.conus_3km.grib2",$hour,$desired_fcst_len);
    } elsif($data_source eq "RRFS_NA_3km_dev1_AK_iso") {
        $anal_dir =
            sprintf("/lfs4/BMC/rtwbl/mhu/wcoss/emc/rrfsna/rrfs_a.%04d%02d%02d/%02d",
                    $year+1900,$month+1,$mday,$hour);
        $template = sprintf("rrfs.t%02dz.prslev.f%03d.ak.grib2",$hour,$desired_fcst_len);
	...
	$anal_dir =
            sprintf("/lfs4/BMC/wrfruc/RRFSE/NCO_dirs/ptmp/com/RRFS_CONUS/para/RRFS_conus_3km.%04d%02d%02d/%02d/mem0001",
                    $year+1900,$month+1,$mday,$hour);
        $template = sprintf("RRFS_CONUS.t%02dz.bgrd3df%03d.tm00.grib2",$hour,$desired_fcst_len);
    } elsif($data_source eq "RRFSE_mem2") {
	$anal_dir =
            sprintf("/lfs4/BMC/wrfruc/RRFSE/NCO_dirs/ptmp/com/RRFS_CONUS/para/RRFS_conus_3km.%04d%02d%02d/%02d/mem0002",
                    $year+1900,$month+1,$mday,$hour);
        $template = sprintf("RRFS_CONUS.t%02dz.bgrd3df%03d.tm00.grib2",$hour,$desired_fcst_len);
    } elsif($data_source eq "RRFSE_mem3") {
	$anal_dir =
            sprintf("/lfs4/BMC/wrfruc/RRFSE/NCO_dirs/ptmp/com/RRFS_CONUS/para/RRFS_conus_3km.%04d%02d%02d/%02d/mem0003",
                    $year+1900,$month+1,$mday,$hour);
        $template = sprintf("RRFS_CONUS.t%02dz.bgrd3df%03d.tm00.grib2",$hour,$desired_fcst_len);
    } elsif($data_source eq "RRFSE_mem4") {
	$anal_dir =
            sprintf("/lfs4/BMC/wrfruc/RRFSE/NCO_dirs/ptmp/com/RRFS_CONUS/para/RRFS_conus_3km.%04d%02d%02d/%02d/mem0004",
                    $year+1900,$month+1,$mday,$hour);
        $template = sprintf("RRFS_CONUS.t%02dz.bgrd3df%03d.tm00.grib2",$hour,$desired_fcst_len);
    } elsif($data_source eq "RRFSE_mem5") {
	$anal_dir =
            sprintf("/lfs4/BMC/wrfruc/RRFSE/NCO_dirs/ptmp/com/RRFS_CONUS/para/RRFS_conus_3km.%04d%02d%02d/%02d/mem0005",
                    $year+1900,$month+1,$mday,$hour);
        $template = sprintf("RRFS_CONUS.t%02dz.bgrd3df%03d.tm00.grib2",$hour,$desired_fcst_len);
    } elsif($data_source eq "RRFSE_mem6") {
	$anal_dir =
            sprintf("/lfs4/BMC/wrfruc/RRFSE/NCO_dirs/ptmp/com/RRFS_CONUS/para/RRFS_conus_3km.%04d%02d%02d/%02d/mem0006",
                    $year+1900,$month+1,$mday,$hour);
        $template = sprintf("RRFS_CONUS.t%02dz.bgrd3df%03d.tm00.grib2",$hour,$desired_fcst_len);
    } elsif($data_source eq "RRFSE_mem7") {
	$anal_dir =
            sprintf("/lfs4/BMC/wrfruc/RRFSE/NCO_dirs/ptmp/com/RRFS_CONUS/para/RRFS_conus_3km.%04d%02d%02d/%02d/mem0007",
                    $year+1900,$month+1,$mday,$hour);
        $template = sprintf("RRFS_CONUS.t%02dz.bgrd3df%03d.tm00.grib2",$hour,$desired_fcst_len);
    } elsif($data_source eq "RRFSE_mem8") {
	$anal_dir =
            sprintf("/lfs4/BMC/wrfruc/RRFSE/NCO_dirs/ptmp/com/RRFS_CONUS/para/RRFS_conus_3km.%04d%02d%02d/%02d/mem0008",
                    $year+1900,$month+1,$mday,$hour);
        $template = sprintf("RRFS_CONUS.t%02dz.bgrd3df%03d.tm00.grib2",$hour,$desired_fcst_len);
    } elsif($data_source eq "RRFSE_mem9") {
	$anal_dir =
            sprintf("/lfs4/BMC/wrfruc/RRFSE/NCO_dirs/ptmp/com/RRFS_CONUS/para/RRFS_conus_3km.%04d%02d%02d/%02d/mem0009",
                    $year+1900,$month+1,$mday,$hour);
        $template = sprintf("RRFS_CONUS.t%02dz.bgrd3df%03d.tm00.grib2",$hour,$desired_fcst_len);
    } elsif($data_source eq "RRFSE_mem1_iso") {
        $anal_dir =
            sprintf("/lfs4/BMC/wrfruc/RRFSE/NCO_dirs/ptmp/com/RRFS_CONUS/para/RRFS_conus_3km.%04d%02d%02d/%02d/mem0001",
                    $year+1900,$month+1,$mday,$hour);
        $template = sprintf("RRFS_CONUS.t%02dz.bgdawpf%03d.tm00.grib2",$hour,$desired_fcst_len);
    } elsif($data_source eq "RRFSE_mem2_iso") {
        $anal_dir =
            sprintf("/lfs4/BMC/wrfruc/RRFSE/NCO_dirs/ptmp/com/RRFS_CONUS/para/RRFS_conus_3km.%04d%02d%02d/%02d/mem0002",
                    $year+1900,$month+1,$mday,$hour);
        $template = sprintf("RRFS_CONUS.t%02dz.bgdawpf%03d.tm00.grib2",$hour,$desired_fcst_len);
    } elsif($data_source eq "RRFSE_mem3_iso") {
        $anal_dir =
            sprintf("/lfs4/BMC/wrfruc/RRFSE/NCO_dirs/ptmp/com/RRFS_CONUS/para/RRFS_conus_3km.%04d%02d%02d/%02d/mem0003",
                    $year+1900,$month+1,$mday,$hour);
        $template = sprintf("RRFS_CONUS.t%02dz.bgdawpf%03d.tm00.grib2",$hour,$desired_fcst_len);
    } elsif($data_source eq "RRFSE_mem4_iso") {
        $anal_dir =
            sprintf("/lfs4/BMC/wrfruc/RRFSE/NCO_dirs/ptmp/com/RRFS_CONUS/para/RRFS_conus_3km.%04d%02d%02d/%02d/mem0004",
                    $year+1900,$month+1,$mday,$hour);
        $template = sprintf("RRFS_CONUS.t%02dz.bgdawpf%03d.tm00.grib2",$hour,$desired_fcst_len);
    } elsif($data_source eq "RRFSE_mem5_iso") {
        $anal_dir =
            sprintf("/lfs4/BMC/wrfruc/RRFSE/NCO_dirs/ptmp/com/RRFS_CONUS/para/RRFS_conus_3km.%04d%02d%02d/%02d/mem0005",
                    $year+1900,$month+1,$mday,$hour);
        $template = sprintf("RRFS_CONUS.t%02dz.bgdawpf%03d.tm00.grib2",$hour,$desired_fcst_len);
    } elsif($data_source eq "RRFSE_mem6_iso") {
        $anal_dir =
            sprintf("/lfs4/BMC/wrfruc/RRFSE/NCO_dirs/ptmp/com/RRFS_CONUS/para/RRFS_conus_3km.%04d%02d%02d/%02d/mem0006",
                    $year+1900,$month+1,$mday,$hour);
        $template = sprintf("RRFS_CONUS.t%02dz.bgdawpf%03d.tm00.grib2",$hour,$desired_fcst_len);
    } elsif($data_source eq "RRFSE_mem7_iso") {
        $anal_dir =
            sprintf("/lfs4/BMC/wrfruc/RRFSE/NCO_dirs/ptmp/com/RRFS_CONUS/para/RRFS_conus_3km.%04d%02d%02d/%02d/mem0007",
                    $year+1900,$month+1,$mday,$hour);
        $template = sprintf("RRFS_CONUS.t%02dz.bgdawpf%03d.tm00.grib2",$hour,$desired_fcst_len);
    } elsif($data_source eq "RRFSE_mem8_iso") {
        $anal_dir =
            sprintf("/lfs4/BMC/wrfruc/RRFSE/NCO_dirs/ptmp/com/RRFS_CONUS/para/RRFS_conus_3km.%04d%02d%02d/%02d/mem0008",
                    $year+1900,$month+1,$mday,$hour);
        $template = sprintf("RRFS_CONUS.t%02dz.bgdawpf%03d.tm00.grib2",$hour,$desired_fcst_len);
    } elsif($data_source eq "RRFSE_mem9_iso") {
        $anal_dir =
            sprintf("/lfs4/BMC/wrfruc/RRFSE/NCO_dirs/ptmp/com/RRFS_CONUS/para/RRFS_conus_3km.%04d%02d%02d/%02d/mem0009",
                    $year+1900,$month+1,$mday,$hour);
        $template = sprintf("RRFS_CONUS.t%02dz.bgdawpf%03d.tm00.grib2",$hour,$desired_fcst_len);
	...
	$anal_dir = "/public/data/grids/rap/iso_130/grib2";
        ...
        $anal_dir =
            sprintf("/home/rtfim/GFSv17p8_HFIP/FV3GFSrun/rt_v17_p8_gf/gfs.%4d%2.2d%2.2d/%2.2d/atmos",
                $year+1900,$month+1,$mday,$hour);
        $template = sprintf("gfs.t%02dz.pgrb2.0p25.f%03d",$hour,$desired_fcst_len);
    } elsif($data_source eq "GFSv17p8_mynn" ) { 
        $anal_dir =
            sprintf("/home/rtfim/GFSv17p8_HFIP/FV3GFSrun/rt_v17_p8_mynn/gfs.%4d%2.2d%2.2d/%2.2d/atmos",
                $year+1900,$month+1,$mday,$hour);
        $template = sprintf("gfs.t%02dz.pgrb2.0p25.f%03d",$hour,$desired_fcst_len);
        ...
        $anal_dir =
            sprintf("/lfs4/BMC/gsd-fv3-dev/rtruns/UFS-CAMsuite_jet/FV3GFSrun/rt_ufscam_l127/gfs.%4d%2.2d%2.2d/%2.2d/atmos",
                $year+1900,$month+1,$mday,$hour);
        $template = sprintf("gfs.t%02dz.pgrb2.0p25.f%03d",$hour,$desired_fcst_len);
