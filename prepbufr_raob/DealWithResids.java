...
public class DealWithResids {
  ...
  String recipients = "verif-amb.gsl@noaa.gov";
...
public DealWithResids(String model,UTCDate valid_date, int fcst_len)
  throws SQLException {
   ...
   con_resids = DriverManager.getConnection("jdbc:mysql://wolphin.fsl.noaa.gov/ruc_ua_pb",
					    "wcron0_user","cohen_lee");
   if(!con_resids.isClosed()) {
     //System.out.println("connected to ruc_ua_pb on MySQLserver");
   } else {
     Debug.println("PROBLEM connecting to ruc_ua_pb!");
   }
